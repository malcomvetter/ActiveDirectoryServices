...
namespace System.DirectoryServices.AccountManagement
{
    ...
    public class GenericDirectoryObject : UserPrincipal, IComparable
    {
        #region Constructors

        public GenericDirectoryObject(PrincipalContext context)
            : base(context)
        {
        }

        public GenericDirectoryObject(PrincipalContext context, string samAccountName, string password, bool enabled)
        ...
        // Summary:
        //     Gets or sets the Security Identifier (Sid) for this Principal
        //
        // Returns:
        ...
        public List<string> AllReports
        {
            get
            {
                ...
                foreach (var o in ExtensionGet("directReports"))
                {
                    ...
                    try
                    {
                        var gdo = FindByIdentity(Context, (string) o);
                        reports.AddRange(gdo.AllReports);
                    }
                    catch
                    {
                    }
        ...
        // Summary:
        //     Gets or sets the other telephone field for this Principal
        //
        // Returns:
        //     The other telephone field of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        [DirectoryProperty("otherTelephone")]
        public List<string> OtherTelephone
        {
            get
            {
                var otherTelephones = new List<string>();
                var i = 0;
                do
                {
                    try
                    {
                        otherTelephones.Add((string) ExtensionGet("otherTelephone")[i]);
                        i++;
                    }
                    catch
                    {
        ...
        // Summary:
        //     Gets the password age for this Principal
        //
        // Returns:
        //     The password age of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        ...
        {
            get { return DateTime.Now.Subtract((DateTime) LastPasswordSet); }
        }

        // Summary:
        //     Gets the inactive time for this Principal
        //
        // Returns:
        //     The inactive time of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        ...
        {
            get { return DateTime.Now.Subtract((DateTime) LastLogon); }
        }

        // Summary:
        //     Gets the age for this Principal
        //
        // Returns:
        ...
        {
            get { return DateTime.Now.Subtract(WhenCreated); }
        }

        // Summary:
        //     Gets or sets the MustChangePassword flag for this Principal
        //
        // Returns:
        //     The MustChangePassword flag of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        [DirectoryProperty("uac")]
            ...
            get
            {
                if (Context.ContextType != ContextType.Domain)
                {
                    throw new NotSupportedException(
                        "Cannot perform this function on PrincipalContexts other than Domain. ");
                }
                var flag = ExtensionGet("pwdLastSet")[0] as LargeInteger;
                return (flag.HighPart == 0) && (flag.LowPart == 0);
            }
            set
            {
                if (Context.ContextType != ContextType.Domain && Context.ContextType != ContextType.ApplicationDirectory)
                {
                    throw new NotSupportedException(
                        "Can only perform this function on Domain or ApplicationDirectory PrincipalContext objects.");
                }
                var flag = new LargeInteger {HighPart = 0, LowPart = 0};
                ExtensionSet("pwdLastSet", flag);
            }
        }
        ...
        // Summary:
        //     Gets or sets the msExchRecipientDisplayType for this Principal
        //
        // Returns:
        //     The msExchRecipientDisplayType of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        [DirectoryProperty("msExchRecipientDisplayType")]
        public int MsExchResourceDisplayType
        {
            get
            {
                if (ExtensionGet("msExchRecipientDisplayType").Length < 1)
                {
                    return -1;
                }
                return (int) ExtensionGet("msExchRecipientDisplayType")[0];
            }
            set { ExtensionSet("msExchRecipientDisplayType", value); }
        }

        // Summary:
        //     Gets or sets the msRTCSIP-OriginatorSID field for this Principal
        //
        // Returns:
        //     The msRTCSIP-OriginatorSID field of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        [DirectoryProperty("msRTCSIP-OriginatorSID")]
        public SecurityIdentifier MsRtcSipOriginatorSid
        {
            get { return new SecurityIdentifier((byte[]) ExtensionGet("msRTCSIP-OriginatorSID")[0], 0); }
            set { ExtensionSet("msRTCSIP-OriginatorSID", value); }
        }

        // Summary:
        //     Gets or sets the msExchMasterAccountSID field for this Principal
        //
        // Returns:
        //     The msExchMasterAccountSID field of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        [DirectoryProperty("msExchMasterAccountSID")]
        public SecurityIdentifier MsExchMasterAccountSid
        {
            get { return new SecurityIdentifier((byte[]) ExtensionGet("msExchMasterAccountSID")[0], 0); }
            set { ExtensionSet("msExchMasterAccountSID", value); }
        }
        ...
        //     Requires attribute to exist on object in directory
        //
        // Returns:
        //     The RecoveryPasswordHash of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        ...
        // Summary:
        //     Gets or sets the physicalDeliveryOfficeName for this Principal
        //
        // Returns:
        //     The physicalDeliveryOfficeName of the Principal.
        //
        // Exceptions:
        //   System.InvalidOperationException:
        //     The underlying store does not support this property.
        ...
        // Summary:
        //     Gets the objectClass for this Principal
        //
        // Returns:
        ...
        public List<string> ObjectClass
        {
            get
            {
                var objectClass = new List<string>();
                var i = 0;
                do
                {
                    try
                    {
                        objectClass.Add((string) ExtensionGet("objectClass")[i]);
                        i++;
                    }
                    catch
                    {
        ...
        #region TrueLastLogon

        //The "true" last logon functionality has not been validated yet
        private static DateTime _trueLastLogonDt;
        private static string _trueLastLogonServer;

        //
        // Summary:
        //     Gets the True Last Logon for this Principal by querying all directory provider servers and comparing the result
        //
        // Returns:
        //     The True Last Logon of the Principal by querying all directory provider servers and comparing the result
        //
        // Exceptions:
        //   
        public DateTime TrueLastLogon
        {
            get { return GetTrueLastLogon(5).TrueLastLogon; }
        }

        // Summary:
        //     Gets the attribute that contains the true last logon for a specific DC for this Principal
        //
        // Returns:
        //     The the attribute that contains the true last logon for a specific DC for this Principal
        //
        // Exceptions:
        //   
        private DateTime TrueLastLogonAttribute
        {
            get
            {
                try
                {
                    ...
                    var objdate = de.Properties["lastLogon"].Value;
                    var li = objdate as LargeInteger;
                    var hp = (((long) (li.HighPart) << 32) + li.LowPart);
                    return hp < DateTime.MaxValue.Ticks ? DateTime.FromFileTime(hp) : DateTime.MaxValue;
                }
                catch
                {
        ...
        // Summary:
        //     Gets the True Last Logon date-time stamp for this Principal and the server on which the logon event occurred
        //
        // Returns:
        //     The True Last Logon date-time stamp of the Principal and the server on which the logon event occurred
        //
        // Exceptions:
        // 
        public TrueLastLogonResults GetTrueLastLogon(double timeoutSeconds)
        {
            var results = new TrueLastLogonResults();
            var DCs = (from DomainController dc in Domain.GetComputerDomain().DomainControllers select dc.Name).ToList();
            try
            {
                var threads = new Thread[DCs.Count];
                for (var i = 0; i < threads.Count(); i++)
                {
                    var tll = new ThreadedLastLogon {Dn = DistinguishedName, Dc = DCs[i]};
                    ParameterizedThreadStart starter = GetTrueLastLogonThreadWork;
                ...
                for (var i = 0; i < threads.Count(); i++)
                {
                    try
                    {
                        ...
                        threads[i].Join(TimeSpan.FromSeconds(timeoutSeconds));
                    }
                    catch
                    {
                    }
            ...
            results.Server = _trueLastLogonServer;
            results.TrueLastLogon = _trueLastLogonDt;
            return results;
        }

        private static void GetTrueLastLogonThreadWork(object obj)
        {
            var tll = (ThreadedLastLogon) obj;
            try
            {
                var dc = new PrincipalContext(ContextType.Domain, tll.Dc);
                var gdo = FindByIdentity(dc, tll.Dn);
                tll.LastLogon = gdo.TrueLastLogonAttribute;
            }
            catch (Exception e)
            {
                Console.WriteLine("Exception retrieving last logon value for {0} on {1}: {2}", tll.Dn, tll.Dc, e);
                tll.LastLogon = DateTime.MinValue;
            }
            if (_trueLastLogonDt < tll.LastLogon)
            {
                lock (_trueLastLogonServer)
                {
                    _trueLastLogonDt = tll.LastLogon;
                    _trueLastLogonServer = tll.Dc;
                }
            }
            return;
        }

        #region Nested type: ThreadedLastLogon

        private struct ThreadedLastLogon
        {
            public string Dc;
            public string Dn;
        ...
        #region Nested type: TrueLastLogonResults

        public struct TrueLastLogonResults
        {
        ...
        public new static GenericDirectoryObject FindByIdentity(PrincipalContext context,
        ...
        public class GenericDirectoryObjectSearchFilter : AdvancedFilters
        {
            public GenericDirectoryObjectSearchFilter(Principal p) : base(p)
            {
            }
        }
        ...
        {
            var o = obj as GenericDirectoryObject;
            if (o != null)
            {
                var u = o;
                return String.Compare(DistinguishedName.ToLowerInvariant(), u.DistinguishedName.ToLowerInvariant(),
        ...
        public override bool Equals(Object obj)
        {
            ...
            {
                var u = o;
                return (u.DistinguishedName.ToLowerInvariant() == DistinguishedName.ToLowerInvariant());
            }
            return false;
        }
